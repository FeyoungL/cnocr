...
if __name__ == '__main__':
    ...
    f_tr = open(os.path.join(pth, 'train.txt'), encoding='utf-8')
    f_ts = open(os.path.join(pth, 'test.txt' ), encoding='utf-8')
    f_st = open('label_cn.txt', 'r', encoding='utf-8')
 
    f_tr2 = open(os.path.join(pth, 'train2.txt'), 'w', encoding='utf-8')
    f_ts2 = open(os.path.join(pth, 'test2.txt' ), 'w', encoding='utf-8')
